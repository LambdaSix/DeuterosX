 ...
 * @addtogroup Skins
 */
class SkinDeuteros extends SkinTemplate {
    /** Using deuteros. */
    function initPage( &$out ) {
        SkinTemplate::initPage( $out );
        $this->skinname  = 'deuteros';
        $this->stylename = 'deuteros';
        $this->template  = 'DeuterosTemplate';
    }
}
 ...
 * @addtogroup Skins
 */
class DeuterosTemplate extends QuickTemplate {
    /**
     * Template filter callback for Deuteros skin.
...
<!-- Deuteros X config -->
 <?php require($GLOBALS['DX_SITE_PATH'] . 'inc/header.php'); ?>
<!-- END Deuteros X config -->
    ...
    <?php		}
            ...
            wfRunHooks( 'DeuterosTemplateToolboxEnd', array( &$this ) );
    ?>
                </ul>
            </div>
        </div>
...
<?php
        $footerlinks = array(
            'lastmod', 'numberofwatchingusers', 'credits', 'copyright',
...
<?php endif; ?>
<!-- Deuteros X config -->
<?php require($GLOBALS['DX_SITE_PATH'] . 'inc/footer.php'); ?>
<!-- END Deuteros X config -->
</body></html>
<?php
    wfRestoreWarnings();
